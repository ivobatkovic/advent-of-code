...
INSTANTIATE_TEST_SUITE_P(
    testLargeNumbers, IntcodeTestPartOne,
    ::testing::Values(std::make_tuple("test_input1.txt", 1219070632396864),
                      std::make_tuple("test_input2.txt", 1125899906842624)));
...
INSTANTIATE_TEST_SUITE_P(testOutput, IntcodeTestPartTwo,
                         ::testing::Values("test_input0.txt"));
