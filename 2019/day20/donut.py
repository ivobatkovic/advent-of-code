...
class Donut:
    ...
    def shortest_path(self, level_check=False):
        ...
        while q:
            ...
            # If the node is outside a portal entrance, teleport. Trick here
            # is to understand that the level must be >= 0 to use outer
            # teleports
    ...
    def find_portals(self):
        ...
        return portals, self.get_reachable_portals(portals, w)

    def get_reachable_portals(self, portals, w):
