...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
      ...
      vector<vector<int>>({{2, 1, -3}, {1, -8, 0}, {3, -6, 1}, {2, 0, 4}}),
      vector<vector<int>>({{-3, -2, 1}, {-1, 1, 3}, {3, 2, -3}, {1, -1, -1}})),
      std::make_tuple("test_input1.txt", 100,
      vector<vector<int>>({{8,-12,-9}, {13,16,-3}, {-29,-11,-1}, {16,-13,23}}),
      vector<vector<int>>({{-7,3,0}, {3,-11,-5}, {-3,7,4}, {7,1,1}}))));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    GravityTestEnergy,
    ::testing::Values(
      std::make_tuple("test_input0.txt",10,179),
