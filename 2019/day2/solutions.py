...
def transform_input(input_):
    return [int(r) for r in input_.split(",")]
...
def part1(input_):
    ...
    return solve_intcode(input_, 12, 2)


def part2(input_):
    input_ = transform_input(input_)
    return solve_intcode_extended(input_, 19690720)
