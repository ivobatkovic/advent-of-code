...
#include "year2022/day1/c/solutions.h"

int main(int argc, char** argv) {
    const char* file_name =
        (argc > 1) ? argv[1] : "year2022/day1/data/input.txt";
    char* input = read_file_contents(file_name);

    clock_t time = clock();
    char* part_one = year2022day1.solve_part1(input);
    time = clock() - time;
    ...
    time = clock();
    char* part_two = year2022day1.solve_part2(input);
    time = clock() - time;
