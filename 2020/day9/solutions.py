...
def part2(input_data, preamble=25):
    input_ = transform_input(input_data)
    # Obtain the invalid number
    invalid_num = part1(input_data, preamble=preamble)
...
def test1(input1, preamble1, output1):
    assert part1(read_input(input1), preamble1) == output1
...
def test2(input2, preamble2, output2):
    assert part2(read_input(input2), preamble2) == output2
